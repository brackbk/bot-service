import ApiResource from './ApiResourceService';

export default class EventService extends ApiResource {
     ...
     * @return {Object} JSON respone
     */
    opportunityLost(payload: Object) {
     ...
     * @return {Object} JSON respone
     */
    orderPlacedItem(payload: Object) {
     ...
     * @return {Object} JSON respone
     */
    cartAbandonedItem(payload: Object) {
     ...
     */
    sendEvent(eventType: string, eventFamily: string, payload: Object) {
        const fields = {
