...
var _ApiResourceService = _interopRequireDefault(require("./ApiResourceService"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class EventService extends _ApiResourceService.default {
  /**
   ...
   */
  conversion(payload) {
    return this.sendEvent(EventService.EVENT_CONVERSION, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  opportunity(payload) {
    return this.sendEvent(EventService.EVENT_OPPORTUNITY, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  opportunityWon(payload) {
    return this.sendEvent(EventService.EVENT_OPPORTUNITY_WON, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  opportunityLost(payload) {
    return this.sendEvent(EventService.EVENT_OPPORTUNITY_LOST, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  orderPlaced(payload) {
    return this.sendEvent(EventService.EVENT_ORDER_PLACED, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  orderPlacedItem(payload) {
    return this.sendEvent(EventService.EVENT_ORDER_PLACED_ITEM, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  cartAbandoned(payload) {
    return this.sendEvent(EventService.EVENT_CART_ABANDONED, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  cartAbandonedItem(payload) {
    return this.sendEvent(EventService.EVENT_CART_ABANDONED_ITEM, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  chatStarted(payload) {
    return this.sendEvent(EventService.EVENT_CHAT_STARTED, EventService.CDP_FAMILY, payload);
  }
  /**
  ...
  chatFinished(payload) {
    return this.sendEvent(EventService.EVENT_CHAT_FINISHED, EventService.CDP_FAMILY, payload);
  }
  /**
...
EventService.EVENT_CONVERSION = 'CONVERSION';
EventService.EVENT_OPPORTUNITY = 'OPPORTUNITY';
EventService.EVENT_OPPORTUNITY_WON = 'SALE';
EventService.EVENT_OPPORTUNITY_LOST = 'OPPORTUNITY_LOST';
EventService.EVENT_ORDER_PLACED = 'ORDER_PLACED';
EventService.EVENT_ORDER_PLACED_ITEM = 'ORDER_PLACED_ITEM';
EventService.EVENT_CART_ABANDONED = 'CART_ABANDONED';
EventService.EVENT_CART_ABANDONED_ITEM = 'CART_ABANDONED_ITEM';
EventService.EVENT_CHAT_STARTED = 'CHAT_STARTED';
EventService.EVENT_CHAT_FINISHED = 'CHAT_FINISHED';
EventService.CDP_FAMILY = 'CDP';