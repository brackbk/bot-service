...
class ConversionService {
  constructor(apikey) {
    this.apiKeyConversion = void 0;
    this.apiKeyConversion = apikey;
  }
  /**
  ...
  async send(payload = {}) {
    ...
    return await _rdstation.default.post(`/platform/conversions?api_key=${this.apiKeyConversion}`, {
...
var _default = ConversionService;
